      ...
      <div style={{ width: "100%", maxWidth: 400, animation: "sode-rise .35s ease" }}>
        ...
        <div className="card" style={{ padding: "28px 28px 24px", borderRadius: 20 }}>
          <div style={{ marginBottom: 22 }}>
            <h1 style={{ fontSize: 21, fontWeight: 800, letterSpacing: "-.02em" }}>Set new password</h1>
            <p style={{ fontSize: 13.5, color: "var(--muted)", marginTop: 5 }}>Choose a strong password for your account.</p>
          </div>
